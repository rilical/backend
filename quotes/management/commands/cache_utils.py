...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--source_country", help="Source country for corridor operations")
        parser.add_argument("--dest_country", help="Destination country for corridor operations")
        parser.add_argument("--provider_id", help="Provider ID for provider operations")
    ...
    def handle(self, *args, **options):
        ...
        try:
            if action == "invalidate_all":
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"Successfully preloaded {count} corridor caches")
                )
