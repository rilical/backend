...
# Import mappings
from providers.westernunion.westernunion_mappings import (
    API_CONFIG,
...
class WesternUnionProvider(RemittanceProvider):
    ...
    def _get_service_name_for_code(self, service_code: str) -> str:
        ...
        from providers.westernunion.westernunion_mappings import DELIVERY_SERVICE_CODES
    ...
    def _get_payment_name_for_code(self, payment_code: str) -> str:
        ...
        from providers.westernunion.westernunion_mappings import PAYMENT_METHOD_CODES
