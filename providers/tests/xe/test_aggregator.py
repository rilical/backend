...
from providers.xe.currency_mapping import (
...
def test_xe_aggregator(
    amount: Decimal, source_currency: str, target_country: str, user_country: str = "US"
):
    """
...
def test_error_handling():
    ...
    with XEAggregatorProvider() as provider:
        ...
        zero_amount_result = provider.get_exchange_rate(
            send_amount=Decimal("0"), send_currency="USD", receive_country="DE"
        )
        results.append(
            {
