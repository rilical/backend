...
from .serializers import APIKeySerializer, UserProfileSerializer, UserSerializer
...
class APIKeyViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        serializer.save(user=self.request.user, key_prefix=prefix, hashed_key=hashed_key)
    ...
    def regenerate(self, request):
        ...
        try:
            ...
            api_key_obj = APIKey.objects.get(
                user=request.user, key_prefix=request.data.get("key_prefix")
            )
