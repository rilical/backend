...
class TestPaysendProvider(unittest.TestCase):
    ...
    def test_live_get_quote(self):
        ...
        try:
            ...
            expected_fields = ["provider", "send_amount", "send_currency", 
    ...
    def test_live_get_exchange_rate(self):
        ...
        try:
            ...
            # Check fields that should exist in a valid response
            expected_fields = ["provider_id", "source_amount", "source_currency", 
                              "destination_amount", "destination_currency", 
                              "exchange_rate", "fee", "corridor"]
    ...
    def test_mock_data_fallback(self):
        ...
        for from_currency, to_currency in test_corridors:
            ...
            with patch.object(self.provider, '_make_api_request') as mock_request:
                ...
                mock_request.side_effect = PaysendApiError("Paysend API requires captcha: Captcha should be solved")
                ...
                print(f"Mock data for {from_currency}-{to_currency}: {json.dumps(result, indent=2, default=str)}")
        ...
        for from_currency, to_currency, from_country, to_country in currency_pairs:
            ...
            try:
                ...
                try:
                    ...
                    print(f"Provider method result: {json.dumps(provider_result, indent=2, default=str)}")
                except Exception as e:
    ...
    def test_live_api_call(self):
        ...
        try:
            ...
            print(f"\n==== LIVE API ERROR ====")
            print(f"Error: {str(e)}")
            print("This is expected if the Paysend endpoint doesn't exist or is different from our implementation.")
            print("==== END ERROR ====\n")
