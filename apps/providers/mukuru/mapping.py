...
CURRENCY_ID_MAPPING = {
    ...
    (
        ...
        "ZW",
        "wallet",
    ): 1693,  # USD Mukuru Wallet (from HTML: data-iso="USD" data-is-send="false")
    (
        "ZA",
        "ZW",
        "cash",
    ): 18,  # Cash USD (from HTML: data-iso="USD" data-is-send="true")
    ("ZA", "ZW", "bank"): 1691,  # Bank deposit USD
    (
        "ZA",
        "ZW",
        "CASH_ZAR",
    ): 31,  # Cash ZAR (from HTML: data-iso="ZAR" data-is-send="true")
    # Other corridors
...
def update_country_currency_mapping(
