...
def main():
    ...
    parser.add_argument('--destination-country', type=str, default='IN', help='Destination country code')
    parser.add_argument('--destination-currency', type=str, default='INR', help='Destination currency')
    ...
    try:
        if args.test_errors:
            ...
            test_corridors = []
            for source_country, source_currency, dest_country, dest_currency in SUPPORTED_CORRIDORS:
