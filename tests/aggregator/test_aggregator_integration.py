...
TEST_CORRIDORS = [
    # Common corridors
    {"source_country": "US", "source_currency": "USD", "destination_country": "MX", "destination_currency": "MXN", "amount": "1000"},
    {"source_country": "US", "source_currency": "USD", "destination_country": "CO", "destination_currency": "COP", "amount": "1000"},
    {"source_country": "US", "source_currency": "USD", "destination_country": "JM", "destination_currency": "JMD", "amount": "1000"},
    
    # European corridors
    {"source_country": "DE", "source_currency": "EUR", "destination_country": "TR", "destination_currency": "TRY", "amount": "1000"},
    {"source_country": "GB", "source_currency": "GBP", "destination_country": "PH", "destination_currency": "PHP", "amount": "1000"},
    
    # Less common corridors
    {"source_country": "NO", "source_currency": "NOK", "destination_country": "BN", "destination_currency": "BND", "amount": "1000"},
    {"source_country": "PL", "source_currency": "PLN", "destination_country": "LT", "destination_currency": "EUR", "amount": "1000"},
    
    # Expected failure case
    {"source_country": "ZZ", "source_currency": "USD", "destination_country": "ZZ", "destination_currency": "ZZZ", "amount": "1000"},
]
...
def pretty_print_result(result: Dict[str, Any], title: str = None) -> None:
    ...
    if success:
        ...
        print(f"✅ SUCCESS: {provider} - {source_amount} {source_currency} → {dest_amount} {dest_currency}")
        print(f"   Rate: {rate}  |  Fee: {fee}  |  Delivery method: {result.get('delivery_method', 'Unknown')}")
    else:
