...
def get_exchange_rate_direct(source_currency: str, target_currency: str, amount: float = 100.0) -> Dict[str, Any]:
    """
...
def main():
    ...
    parser.add_argument("--live", action="store_true", help="Use live API with authentication (requires WISE_API_KEY)")
    parser.add_argument("--direct", action="store_true", help="Use direct mode with unauthenticated API")
