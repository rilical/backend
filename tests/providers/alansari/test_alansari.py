...
class TestAlAnsariLive(unittest.TestCase):
    ...
    def test_aed_to_inr_500(self):
        ...
        self.assertTrue(quote["success"], f"Expected success but got error: {quote.get('error_message')}")
        self.assertGreater(quote["destination_amount"], 0, "Destination amount should be greater than 0")
    ...
    def test_unsupported_corridor(self):
        ...
        self.assertIsNotNone(quote["error_message"], "Expected an error_message for unsupported corridor.")
    ...
    def test_negative_amount(self):
        ...
        self.assertIsNotNone(quote["error_message"], "Expected an error_message for negative amount.")
