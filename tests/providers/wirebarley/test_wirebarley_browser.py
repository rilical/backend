...
class TestWireBarleyBrowser(unittest.TestCase):
    ...
    def test_browser_flow(self):
        ...
        for source_country, source_currency in [
            ("NZ", "NZD"),
            ("US", "USD"),
            ("CA", "CAD"),
        ]:
            ...
            try:
                ...
                with open(
                    f"api_responses/wirebarley_{source_currency.lower()}_browser.json",
                    "w",
                ) as f:
                ...
                with open(
                    f"api_responses/wirebarley_{source_currency.lower()}_error.txt",
                    "w",
                    encoding="utf-8",
                ) as f:
